...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="{{ asset('assets/dashmix.min.css') }}">

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="assets/css/themes/xwork.min.css"> -->
    <link rel="stylesheet" id="css-theme" href="{{ asset('assets/xwork.min.css') }}">
                ...
                <div class="row justify-content-center h-100 align-items-center">
                    <div class="col-xl-8 col-md-8">
                        <div class="auth-form card">
                            <div class="card-body">
                                <form method="GET" action="{{ route('contract_details', $project->id) }}"  id="form"  class="identity-upload">
                                    @csrf
                                    <div class="identity-content">
                                        <span class="icon"><i class="fa fa-shield"></i></span>
                                        <h4>Processing contract information, Please dont close this page</h4>
                                    </div>
                                    ...
                                    <div style="margin-top: 10px">
                                        <p id="status" style="color: red">Initiating contract information please hold on ......</p>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        if (i == 0) {
            ...
            function frame() {
                if (width >= 100) {
                    ...
                    if(width < 30){
                        elem.innerHTML = 'Initiating process ....';
                    }else {
                    ...
                    if(width > 10){
                        ...
                        status.innerHTML = 'Verifying contract information ....';
                    }if(width > 55){
                    ...
                    if(width > 75){
                        status.style.color = 'blue';
                        status.innerHTML = 'Finalizing process ......';
                    }
                    if(width > 85){
                        status.style.color = 'blue';
                        status.innerHTML = 'Getting contract information......';
                    }
                    if(width > 98){
                        status.style.color = 'blue';
                        status.innerHTML = 'Tracking Successful ......';
                    }
                }
            }
        }
