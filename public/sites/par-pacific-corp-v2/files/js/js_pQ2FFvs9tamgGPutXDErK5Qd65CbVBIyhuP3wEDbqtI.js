...
jQuery(document).ready(function(){jQuery('iframe.responsive').iFrameResize({log:false,resizedCallback:function(messageData){setContentwrapper();}});});jQuery(window).resize(function(){if(jQuery("iframe.responsive").length>0){jQuery("iframe.responsive").each(function(){jQuery(this).css("width",jQuery(this).parent('div').width()+"px");});}});;
/*!
 * jQuery Form Plugin
 * version: 4.2.2
