    ...
    NioApp.CurrentLink = function(){
        ...
        $(_link).each(function() {
            ...
            if (fileName.match(_self_link)) {
                self.closest("li").addClass('active current-pages').parents().closest("li").addClass("active current-pages");
                self.closest("li").children('.nk-menu-sub').css('display','block');
                self.parents().closest("li").children('.nk-menu-sub').css('display','block');
            } else {
                self.closest("li").removeClass('active current-pages').parents().closest("li:not(.current-pages)").removeClass("active");
            }
        });
    };
